...
//			bookList.add(book);
		...
		try {
			...
			if(params.isEmpty()) {
			...
			} else if(params.get("bookName") != null && params.get("authorName") != null && params.get("publisherName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
				...
				pstmt = con.prepareStatement(sql);
				pstmt.setInt(1, 0);
				pstmt.setString(2, "%" + params.get("bookName") + "%");
				pstmt.setString(3, "%" + params.get("authorName") + "%");
				pstmt.setString(4, "%" + params.get("publisherName")+ "%");
				
				
			} else if(params.get("bookName") != null && params.get("authorName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
			...
			} else if(params.get("authorName") != null && params.get("publisherName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
				...
				pstmt = con.prepareStatement(sql);
				pstmt.setInt(1, 0);
				pstmt.setString(2,  "%" + params.get("authorName") + "%");
				pstmt.setString(3, "%" + params.get("publisherName") + "%");
				
				
				
			} else if(params.get("bookName") != null && params.get("publisherName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
			...
			} else if(params.get("bookName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
			...
			} else if(params.get("authorName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
			...
			} else if(params.get("publisherName") != null) {
				sql = "select\r\n"
						+ "	*\r\n"
						+ "from\r\n"
						+ "	book_view\r\n"
				...
				pstmt = con.prepareStatement(sql);
				pstmt.setInt(1, 0);
				pstmt.setString(2, "%" + params.get("publisherName") + "%");
